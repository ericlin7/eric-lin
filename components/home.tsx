      ...
      <div className="text-sm sm:text-base md:text-md lg:text-lg text-gray-600 w-full max-w-3xl px-2 sm:px-4">
        <div className="flex flex-col-reverse items-center sm:flex-row sm:items-start mt-8 sm:mt-12">
          ...
          <div className="flex justify-center w-full sm:w-auto">
            <Face src={"/eric.png"} alt="EL" height="175px" width="175px" />
          </div>
        </div>
        <p className="mt-2 sm:mt-4 text-left leading-relaxed">
          I'm a Senior Data Science student at the University of Waterloo. I
          like learning about Machine Learning and Data Science related topics.
          I also enjoy building stuff and learning new tech skills.
        </p>
